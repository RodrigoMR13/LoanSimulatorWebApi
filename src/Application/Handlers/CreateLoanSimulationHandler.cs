...
{
    public class CreateLoanSimulationHandler(IProductRepository productRepository,
        ...
        ) : IRequestHandler<CreateLoanSimulationRequest, CreateLoanSimulationResponse>
    {
        ...
        public async Task<CreateLoanSimulationResponse> Handle(CreateLoanSimulationRequest request,
            CancellationToken cancellationToken)
        {
            ...
            var response = new CreateLoanSimulationResponse(loanSimulation.Id, appropriateProduct.Id, appropriateProduct.Name,
        ...
        private async Task<Product?> SearchAppropriateProduct(CreateLoanSimulationRequest request)
        {
