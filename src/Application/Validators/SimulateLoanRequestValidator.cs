...
{
    public class SimulateLoanRequestValidator : AbstractValidator<CreateLoanSimulationRequest>
    {
        ...
        private async Task<bool> BeValidForSomeProduct(CreateLoanSimulationRequest request, CancellationToken cancellationToken)
        {
